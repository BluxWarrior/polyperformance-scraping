...
(async () => {
  ...
  await page.goto(
    "https://www.polyperformance.com/fox-20psrsbcdgm-parent-item-fox-20-performance-series-reservoir-w-cd-adjuster-shocks-for-chevygmc",
    { timeout: 60000 }
  );
  await sleep(3000);
  ...
  fs.writeFileSync("test.json", jsonContent, "utf8", (err) => {
    if (err) {
